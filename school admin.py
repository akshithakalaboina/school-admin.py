...
# ------------------------------------------------TEACHER MODULE 1 (Attendance Register) START-------------------------------------------#
...
def Attendance ():
    ...
    Frame(AttendanceReg, height=40, width=1280, bg='#3C6739').place(relx=0, y=0)
    Label(AttendanceReg, text='ATTENDANCE REGISTER', font=('impact', 18), bg='#3C6739', fg='white').place(relx=0.4,
                                                                                                          rely=0)
...
# @@@@@@@@@@@@@@@@@@@@@@@@@@@@@@@@@@@@@@@@@@@@@@ LeftMayFrame 1 @@@@@@@@@@@@@@@@@@@@@@@@@@@@@@@@@@@
    ...
    #btnExit = Button(LeftMayFrame1, text='Exit', pax=2, paddy=2, bd=2, fg='black', font=('arial', 10, 'bold'), width = 12, height = 1).grid(row=0, column = 7)
...
DateOrder = Label(LeftMayFrame1, font = ('arial', 10, 'bold'), textvariable = DateOrder, pax=2, paddy= 2, bd =2, fg='black', bg='white', relief ='sunken').place(x=900, rely=0.3)
...
class LeftMayFrame2:
    ...
    Aframe = Frame(AttendanceReg, height=35, width=1280, bg='#3C6739').place(relx=0, y=685)
#------------------------------------------------TEACHER MODULE 1 END-------------------------------------------#
...
def TeacherLogin ():
    ...
    Frame(TeacherLoginForm, height=50, width=1277, bg='#3C6739').place(relx=0, y=30)
    Frame(TeacherLoginForm, height=80, width=1277, bg='#F0F0F0').place(x=0, y=90)
    Label(TeacherLoginForm, font=('impact', 30, 'bold'), text="TEACHER'S LOGIN").place(relx=0.4, y=100)
    Frame(TeacherLoginForm, height=50, width=1277, bg='#3C6739').place(relx=0, y=180)

    Label(TeacherLoginForm, text='username', bg='white', font=('arial', 20)).place(x=490, y=356)
    ttk.Entry(TeacherLoginForm, textvariable=USERNAME, font=('arial', 20)).place(relx=0.5, rely=0.5)
    Label(TeacherLoginForm, text='password', bg='white', font=('arial', 20)).place(x=490, y=410)
    ttk.Entry(TeacherLoginForm, textvariable=PASSWORD, font=('arial', 20), show='*').place(x=639, y=410)
    Button(TeacherLoginForm, text='LOGIN', padx=190, pady=5, font=('arial', 12, 'bold'), bg='#3C6739',
           fg='white', command=TLogin).place(relx=0.39, y=470)
    Label(TeacherLoginForm, text='', fg='red', bg='white', font=('arial', 15)).place(relx=0.43, rely=0.72)
...
def StudentLogin():
    ...
    Label(StudentLoginForm, text='username', bg='white', font=('arial', 20)).place(x=490, y=356)
    ttk.Entry(StudentLoginForm, font=('arial', 20), textvariable=USERNAME).place(relx=0.5, rely=0.5)
    Label(StudentLoginForm, text='password', bg='white', font=('arial', 20)).place(x=490, y=410)
    ttk.Entry(StudentLoginForm, font=('arial', 20), textvariable=PASSWORD, show='*').place(x=639, y=410)
    Button(StudentLoginForm, text='LOGIN', padx=190, pady=5, font=('arial', 12, 'bold'), bg='#3C6739', fg='white',
           command=TLogin).place(relx=0.39, y=470)
    Label(StudentLoginForm, text='', fg='red', bg='white', font=('arial', 15)).place(relx=0.43, rely=0.72)
